// Two-dimensional Arrays & Three-dimensional Arrays (Nested Arrays)
...
const sportsStore = [equipmentDepartment,clothesDepartment];
// theorethically explained - go to "equipmentDepartment", then go to "equipmentShelfA", then get the "baseball"
console.log(sportsStore[0][0][0]);
// theorethically explained - go to "clothesDepartment", then go to "clothesShelfB", then get the "hoodies"
